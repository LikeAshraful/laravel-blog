    ...
    <div id="page-wrapper">
        <div class="row">
            ...
            <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                ...
                <form action="{{ route('admin.edit_category', $category->id) }}" method="post">
                    @csrf
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-5.5 p-6.5">
                                    ...
                                    <div>
                                        ...
                                        <textarea rows="6" placeholder="Post Content" name="description"
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                                            {{ $category->description }}
                                        </textarea>
                                    </div>
                        ...
                        <div class="gap-0 col-span-12 lg:col-span-6">
                            <div class="flex flex-col gap-10">
                                <div
                                    ...
                                    {{ $categories->links('admin.includes.custom-pagination') }}
                                </div>
                            </div>
                        </div>
                    </div>
