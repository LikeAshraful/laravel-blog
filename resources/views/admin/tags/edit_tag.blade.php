                                ...
                                <div class="flex flex-col gap-5.5 p-6.5">
                                    <div>
                                        ...
                                        <input type="text" placeholder="Title"
                                            ...
                                            value="{{ old('name') ?? $tag->name }}" name="name" />
                                    </div>

                                    <div>
                                        <button type="submit"
                                            class="inline-flex items-center justify-center bg-primary py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10">Update</button>
